...
i'm a group manager bot. Maintained by @Its_Ayeshu ❤
...
SAITAMA_IMG = "https://telegra.ph/file/0dace7d94a29afa762e5a.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
Supporting him; [AYESHU](t.me/its_Ayeshu)"""
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="👰 Add 𝘽𝙇𝘼𝘾𝙆𝙋𝙄𝙉𝙆 to your group",
                     ...
                     [
                         InlineKeyboardButton(
                             text="Support Group",
                             url=f"https://t.me/BlacK_PinK_SupporT"),
                         InlineKeyboardButton(
                             text="📘 Logs",
                             url="https://t.me/black_pink_updates")
                     ],
                     [
                         InlineKeyboardButton(
                             text="☑️ Source code",
                             url="https://github.com/TheAyeshu/BlackPinkRoBoT")
                     ]]))
    else:
